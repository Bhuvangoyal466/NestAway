        ...
        {bookings?.length > 0 ? (
          ...
          <div className="">
            <div className="flex flex-col justify-start">
              <h1 className="my-6 text-3xl text-white font-semibold">Trips</h1>
              <hr className="border border-gray-300" />
              <h3 className="pt-6 text-white text-2xl font-semibold">
                No trips booked... yet!
              </h3>
              ...
              <Link to="/" className="my-4">
                <div className="flex w-40 text-white justify-center rounded-lg border border-white p-3 text-lg font-semibold hover:bg-gray-50">
                  Start Searching
                </div>
              </Link>
            </div>
