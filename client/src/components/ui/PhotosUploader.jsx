  ...
  return (
    <>
      <div className="flex gap-2">
        ...
        />
        <button
          className="rounded-2xl text-white glass-button bg-gray-200 px-4"
      ...
      <div className="mt-2 grid grid-cols-3 gap-2 md:grid-cols-4 lg:grid-cols-6 ">
        ...
        <label className="flex h-32 cursor-pointer items-center justify-center gap-1 rounded-2xl border bg-transparent p-2 text-2xl text-white">
          <input
            type="file"
            multiple
            className="hidden"
